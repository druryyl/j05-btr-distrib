CREATE TABLE BTR_Opname(
    OpanameId VARCHAR(13) NOT NULL CONSTRAINT DF_BTR_Opname_OpanameId DEFAULT(''),
    OpanameDate DATETIME NOT NULL CONSTRAINT DF_BTR_Opname_OpanameDate DEFAULT(''),
    UserId VARCHAR(50) NOT NULL CONSTRAINT DF_BTR_Opname_UserId DEFAULT(''),
    BrgId VARCHAR(5) NOT NULL CONSTRAINT DF_BTR_Opname_BrgId DEFAULT(''),
    ...
    Satuan1 VARCHAR(13) NOT NULL CONSTRAINT DF_BTR_Opname_Satuan1 DEFAULT(''),
    ...
    Satuan2 VARCHAR(13) NOT NULL CONSTRAINT DF_BTR_Opname_Satuan2 DEFAULT(''),
