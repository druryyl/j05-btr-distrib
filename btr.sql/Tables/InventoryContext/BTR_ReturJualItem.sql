...
CREATE TABLE BTR_ReturJualItem(
    ...
    QtyInputStrRusak VARCHAR(50) NOT NULL CONSTRAINT DF_BTR_ReturJualItem_QtyInputStrRusak DEFAULT(''),
    ...
    QtyRusak INT NOT NULL CONSTRAINT DF_BTR_ReturJualItem_QtyRusak DEFAULT(0),
