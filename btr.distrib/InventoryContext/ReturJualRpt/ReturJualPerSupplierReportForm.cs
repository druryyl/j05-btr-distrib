...
namespace btr.distrib.InventoryContext.ReturJualRpt
{
    ...
    public partial class ReturJualPerSupplierReportForm : Form
    {
        ...
        public ReturJualPerSupplierReportForm(IOmzetSupplierViewDal omzetSupplierViewDal)
        {
            InitializeComponent();
            ...
            BulananRadio.CheckedChanged += BulananRadio_CheckedChanged;
            HarianRadio.CheckedChanged += BulananRadio_CheckedChanged;
        ...
        private void ExcelButton_Click(object sender, EventArgs e)
        {
            ...
            using (var saveFileDialog = new SaveFileDialog())
            {
                ...
                saveFileDialog.FileName = $"retur-jual-per-supplier-{DateTime.Now:yyyy-MM-dd-HHmm}";
        ...
        private void ExcelBulanan(string filePath)
        {
            ...
            {
                wb.AddWorksheet("Retur-Jual-Per-Supplier")
                    .Cell($"B1")
        ...
        private void ProsesBulanan()
        {
            ...
            var listOmzet = _omzetSupplierViewDal.ListDataRetur(periode)?.ToList() ?? new List<OmzetSupplierView>();
