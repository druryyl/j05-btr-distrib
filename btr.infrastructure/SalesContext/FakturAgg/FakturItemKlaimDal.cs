...
{
    public class FakturItemKlaimDal : IFakturItemKlaimDal
    {
        private readonly DatabaseOptions _opt;

        public FakturItemKlaimDal(IOptions<DatabaseOptions> opt)
        {
            _opt = opt.Value;
        }
        ...
        public void Insert(IEnumerable<FakturItemModel> listModel)
        {
            ...
            using (var bcp = new SqlBulkCopy(conn))
            {
                ...
                bcp.DestinationTableName = "dbo.BTR_FakturItemKlaim";
